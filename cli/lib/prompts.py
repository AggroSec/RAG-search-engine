spell_prompt = """Fix any spelling errors in the user-provided movie search query below.
...
def get_prompt(enhancement: str, query: str) -> str:
    match enhancement:
        case "spell":
        ...
        case _:
            raise ValueError("incorrect enhancement passed")